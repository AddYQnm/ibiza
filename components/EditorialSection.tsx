...
/*
  CORRECTIF INP :
  - Avant : 4 blocs motion séparés avec whileInView → 4 IntersectionObservers créés,
    4 timers d'animation, overhead JS inutile lors des interactions utilisateur.
  - Après : 1 seul motion.div parent avec staggerChildren + whileInView.
    Tous les enfants s'animent ensemble via variants → 1 seul observer, moins de tâches JS.
*/
  ...
  return (
    <section className="relative overflow-hidden py-28 md:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        {/*
          1 seul motion.div avec whileInView + staggerChildren.
          Les enfants héritent des variants "fadeUp" → 1 seul IntersectionObserver.
        */}
        <motion.div
